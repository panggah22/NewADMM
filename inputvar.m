...
inp.Qbessc = inp.Pbessc(end) + (1:lent.Qbessc);
inp.Pbessd = inp.Qbessc(end) + (1:lent.Pbessd);
inp.Qbessd = inp.Pbessd(end) + (1:lent.Qbessd);
inp.Pevcs = inp.Qbessd(end) + (1:lent.Pevcs);
inp.Qevcs = inp.Pevcs(end) + (1:lent.Qevcs);
inp.Ppv = inp.Qevcs(end) + (1:lent.Ppv);
inp.Qstar = inp.Ppv(end) + (1:lent.Qstar);
